            ...
            if (myConn != null) {
                ...
                while (reset.next()) {
                    Person p = new Person(reset.getInt("person_id"), reset.getInt("role_foreign_id"), reset.getString("person_full_name"), reset.getString("person_email"),
                            reset.getString("person_username"), reset.getString("person_password"), reset.getString("person_phone_no"), reset.getString("person_birthday"));
                    PersonList.add(p);
                }
                //conn.close();
            }
        ...
        if (myConn != null) {
            try {//TEST
                ...
                String qry = "UPDATE [Roshna_Sara_CarParkingIMS].[dbo].[table_people]\n"
                        ...
                        //                     PROBLEM HERE  
                          + "           ,[person_birthday] = '" +newPerson.person_birthday + "'\n"
